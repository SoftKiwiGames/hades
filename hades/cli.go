...
func (h *Hades) buildRunCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			planName := args[0]
			return h.runPlan(planName, configDir, targets, envVars, follow, dryRun)
		},
	}
...
func (h *Hades) runPlan(planName, configDir string, targets, envVars []string, follow bool, dryRun bool) error {
	...
	result, err := exec.ExecutePlan(ctx, file, plan, planName, inv, targets, expandedEnv, follow)
	if err != nil {
